...
function ReactDateRangePicker({
  ...
  return (
    <>
      {/* <div className="relative w-fit h-[39px] rounded-xl  hidden lg:flex items-center px-3 gap-3 truncate border-2 border-gray-800 bg-white hover:bg-rsecondary/60">
        ...
        <span className="cursor-pointer w-full truncate text-xs sm:text-sm md:text-base ">
          <span onClick={() => setIsStartOpen(!isStartOpen)}>
            {currentStartDate}
          </span>{" "}
          -{" "}
          <span onClick={() => setIsEndOpen(!isEndOpen)}>{currentEndDate}</span>
        </span>
      </div> */}
      <div className="  justify-start items-center mt-3  gap-3 hidden lg:flex">
            <div class="w-full">
              <label
                for="email"
            ...
            <button onClick={() => 
                handleApply()} className="text-white font-bold px-4 py-2 rounded-lg bg-green-500">
              Apply
            </button>
          </div>
      ...
      >
        <section className=" flex flex-col justify-start item-center w-full h-full ">
          ...
          <div className="lg:hidden flex gap-2 justify-end">
            <BasicButton
              className={"w-1/4 py-2  bg-white focus:bg-gray-200"}
              title={"Reset"}
              onClick={handleReset}
            />
            <BasicButton
