...
const Rating = ({ score, reviews }) => (
    <div className="flex justify-between">
        ...
        <div onClick={() => scrollToDiv("productReview")} className="flex items-center ">
        ...
        <BasicButton onClick={() => scrollToDiv("offersAvailable")} className={'text-white bg-gray-500 rounded-lg py-1 text-xs px-2 flex gap-1'}>
            ...
            </svg><span>Offers Available</span>
        </BasicButton>
    </div>
);
