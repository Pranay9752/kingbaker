...
const StatusBar = ({ className, title, icon = false, onClick }) => {
  return (
    <div
      onClick={onClick}
      className={twMerge(
        "flex justify-between items-center lg:flex-none bg-white shadow-lg rounded-lg p-4 mb-4 group ",
        className
      )}
    >
      {/* Title and Icon */}
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="size-6 group-hover:text-gray-900 text-gray-600"
      >
        <path
          fillRule="evenodd"
