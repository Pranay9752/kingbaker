        ...
        <footer className="bg-white text-gray-600 py-8 mt-2">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap justify-between mb-8">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4 text-center mb-4">
                        <svg className="w-8 h-8 mx-auto mb-2 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4 text-center mb-4">
                        ...
                        <p className="text-sm">
                            <a href="#" className="text-blue-500 hover:underline">Chat with us</a>
                        </p>
                    </div>
                    <div className="w-full sm:w-1/2 md:w-1/4 text-center mb-4">
                        <div className="flex justify-center mb-2">
                            <svg className="w-8 h-8 text-green-500 mr-2" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M17.6 9.48l1.84-3.18c.16-.31.04-.69-.26-.85a.532.532 0 0 0-.79.15l-1.88 3.24a11.647 11.647 0 0 0-8.86 0L5.65 5.6a.532.532 0 0 0-.79-.15c-.3.16-.42.54-.26.85l1.84 3.18A11.712 11.712 0 0 0 1 20h22a11.712 11.712 0 0 0-5.4-10.52z" /></svg>
                            <svg className="w-8 h-8 text-gray-500" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M22 17.607c-.786 2.28-3.139 6.317-5.563 6.361-1.608.031-2.125-.953-3.963-.953-1.837 0-2.412.923-3.932.983-2.572.099-6.542-5.827-6.542-10.995 0-4.747 3.308-7.1 6.198-7.143 1.55-.028 3.014 1.045 3.959 1.045.949 0 2.727-1.29 4.596-1.101.782.033 2.979.315 4.389 2.377-3.741 2.442-3.158 7.549.858 9.426zm-5.222-17.607c-2.826.114-5.132 3.079-4.81 5.531 2.612.203 5.118-2.725 4.81-5.531z" /></svg>
                        </div>
                ...
                <div className="flex flex-wrap mb-8">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/5 mb-4">
                        ...
                        <ul className="text-sm">
                            <li><Link to={''} className="hover:text-gray-800">Contact Us</Link></li>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/5 mb-4">
                        ...
                        <ul className="text-sm">
                            <li><a href="#" className="hover:text-gray-800">Quotes N Wishes</a></li>
                            <li><a href="#" className="hover:text-gray-800">Flower Astrology</a></li>
                            <li><a href="#" className="hover:text-gray-800">Article Hub</a></li>
                            <li><a href="#" className="hover:text-gray-800">Care Guide</a></li>
                ...
                <div className="mb-8">
                    ...
                    <div className="flex w-1/4">
                        <input type="email" placeholder="Email" className="flex-grow border border-gray-300 px-3 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-orange-500" />
                        <button className="bg-orange-500 text-white px-4 py-2 rounded-r-md hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500">SUBMIT</button>
                    </div>
                    <p className="text-sm mt-2">Get updates on promotions and offers coupons.</p>
                </div>
                ...
                <div className="flex flex-wrap items-center justify-between pt-8 border-t border-gray-200">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <a href="#" className="text-red-600 hover:text-red-800">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C5.373 0 0 5.372 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738a.36.36 0 01.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.631-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24 12 24c6.627 0 12-5.373 12-12 0-6.628-5.373-12-12-12z" /></svg>
                        </a>
