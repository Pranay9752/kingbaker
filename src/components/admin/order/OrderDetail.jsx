...
const OrderDetailsCard = ({ order, onClose = () => {}, darkMode = false }) => {
  ...
  return (
    ...
    // </div>
    <div
      className={`rounded-lg w-full shadow-lg p-6 mb-4 relative ${
        darkMode ? "bg-[#1a1f25]" : "bg-white"
      }`}
    >
      <div onClick={onClose} className="absolute right-2 top-2 text-gray-200 cursor-pointer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          fill="currentColor"
      ...
      <div className="mb-6">
        ...
        >
          <div
            className={`flex items-center mb-1.5 py-1.5 px-3 rounded-lg border ${
              darkMode ? "border-gray-700" : "border-gray-800"
            }`}
          >
            <img
              src={
