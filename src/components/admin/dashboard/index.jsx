...
//             Muzaffarnagar Medical College and Hospital, Muzaffarnagar, UP, India
//           </Text>
...
//         <View style={styles.section}>
//           <Text style={styles.text}> 5608627601</Text>
...
//                 Chocolate Cream Cake Half kg Eggless
//               </Text>
...
//           <Text style={styles.text}>
//             May your birthday be sweet as chocolates, fragrant as flowers and
//             awesome as you are!
//           </Text>
//           <Text style={styles.text}>
//             Sending you loads of hugs, love and best wishes on your special day!
    ...
    <Page size="A4" style={styles.page}>
      <View style={{ ...styles.section, border: "1px solid #000" }}>
        ...
        >
          <View style={{ ...styles.section }}>
            <Text style={styles.heading}>Deliver To:</Text>
            <Text style={styles.text}>Ashu Baliyan</Text>
            <Text style={styles.text}>neetipanwar937@gmail.com</Text>
            <Text style={styles.text}>
              House no. 3, Bhoura Kalan, Muzaffarnagar, UP
            </Text>
            <Text style={styles.text}>Muzaffarnagar - 251319</Text>
            <Text style={styles.text}>India</Text>
          ...
          <View style={{ ...styles.section }}>
            <Text style={styles.text}>
              <Text style={styles.heading}>Order #:</Text> 5638808902
            </Text>
            <Text style={styles.text}>
              <Text style={styles.heading}>Order Date:</Text> 05-10-2024
            </Text>
            <Text style={styles.text}>
              <Text style={styles.heading}>Delivery Date:</Text> 09-10-2024
            </Text>
            <Text style={styles.text}>
              <Text style={styles.heading}>Shipping:</Text> Standard-Delivery
            </Text>
            <Text style={styles.text}>
              <Text style={styles.heading}>Time:</Text> 07:00:00 - 20:00:00
            </Text>
            <Text style={styles.text}>
              <Text style={styles.heading}>DelAreaName:</Text>
              muzafarnagar-os_ECDA
            </Text>
          </View>
        </View>
        {/* Deliver To Section */}
        ...
        <View style={styles.table}>
          ...
          {/* Product 1 */}
          <View style={styles.tableRow}>
            <View style={{ ...styles.tableCol, padding: "5px", width: "15%" }}>
              <Image
            ...
            <View style={styles.tableCol}>
              ...
              <Text style={styles.tableCell}>CAKE78132</Text>
              <Text style={styles.tableCell}>EGFLACAKES19-044-A</Text>
              ...
              >
                <Text style={styles.heading}>Weight:</Text> 1.5KG
              </Text>
            </View>
            <View style={{ ...styles.tableCol, width: "50%" }}>
              <Text style={styles.tableCell}>Weight: 1/2 KG</Text>
              <Text style={styles.tableCell}>Cake Flavour: Butterscotch</Text>
              <Text style={styles.tableCell}>Version: Eggless</Text>
              <Text style={styles.tableCell}>Type: Cream</Text>
              <Text style={styles.tableCell}>Shape: Round</Text>
              <Text style={styles.tableCell}>Serves: 4-6 People</Text>
              <Text style={styles.tableCell}>Candles & Knife Included</Text>
            </View>
        ...
        >
          ...
          <Text style={styles.heading}>
            ...
            >
              {`      `}Happy Birthday, my love! May you always find the courage
              and strength to pursue your dreams.
            </Text>
          </Text>

          <Text style={styles.heading}>
            Sender: <Text style={styles.text}>Neeti</Text>
          </Text>
        </View>
      </View>
    </Page>
...
function AdminDashboard() {
  ...
  const handleDownload = async (e) => {
    ...
    const blob = await ReactPDF.pdf(<ChallanPDF />).toBlob();
