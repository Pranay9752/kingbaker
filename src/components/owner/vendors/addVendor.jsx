...
import { useCreateVendorMutation } from "../../../redux/apiSlices/owner/vendor";
...
const AddVendorModal = ({ onClose, onSubmit }) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end items-center gap-3">
          ...
          <BasicButton
            type={"submit"}
            className={
              "border-gray-300 text-gray-300 px-4 py-2 bg-green-800/50 rounded-lg"
            }
            disabled={isLoading}
          >
