...
// // AddVendor Modal Component
// const AddVendorModal = ({ onClose, onSubmit, initialData }) => {
...
//   const isUpdate = useMemo(() => !!initialData, [initialData]);

//   const [createVendor, { isLoading: isCreating }] = useCreateVendorMutation();
//   const [updateOwnerOrVendor, { isLoading: isUpdating }] = useUpdateOwnerOrVendorMutation()
//   const validateForm = () => {
//     const newErrors = {};
...
//       newErrors["coordinates.longitude"] = "Longitude is required";
//     if (!formData.coordinates.latitude)
//       newErrors["coordinates.latitude"] = "Latitude is required";
...
//       const response = createVendor(payload).unwrap();
...
//             type={"submit"}
//             className={
//               "border-gray-300 text-gray-300 px-4 py-2 bg-red-800/50 rounded-lg"
//             }
//             disabled={isCreating}
//             onClick={onClose}
//           >
